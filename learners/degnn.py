...
class DEGNN(nn.Module):
    def __init__(self, layers, in_features, hidden_features, out_features, prop_depth, args, dropout=0.0, model_name='DE-GNN'):
        super(DEGNN, self).__init__()
        self.n_layers, self.in_features, self.hidden_features, self.out_features, self.model_name, self.args = layers, in_features, hidden_features, out_features, model_name, args
